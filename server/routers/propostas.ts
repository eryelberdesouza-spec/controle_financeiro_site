...
const propostaInputSchema = z.object({
  ...
  escopoDetalhado: z.string().nullable().optional(),
  prazoPadraoId: z.number().nullable().optional(),
  prazoPadraoTexto: z.string().nullable().optional(),
  prazoInicio: z.string().nullable().optional(),
  condicoesInicio: z.string().nullable().optional(),
  observacoesCondicoes: z.string().nullable().optional(),
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const [result] = await db.insert(propostas).values({
        ...
        escopoDetalhado: input.escopoDetalhado ?? null,
        prazoPadraoId: input.prazoPadraoId ?? null,
        prazoPadraoTexto: input.prazoPadraoTexto ?? null,
        prazoInicio: input.prazoInicio ?? null,
        condicoesInicio: input.condicoesInicio ?? null,
        observacoesCondicoes: input.observacoesCondicoes ?? null,
  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input }) => {
      ...
      await db.update(propostas).set({
        ...
        escopoDetalhado: data.escopoDetalhado ?? null,
        prazoPadraoId: data.prazoPadraoId ?? null,
        prazoPadraoTexto: data.prazoPadraoTexto ?? null,
        prazoInicio: data.prazoInicio ?? null,
        condicoesInicio: data.condicoesInicio ?? null,
        observacoesCondicoes: data.observacoesCondicoes ?? null,
